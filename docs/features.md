...
- Display name **Pixelview Desktop**, bundle `Pixelview Desktop.app`, bundle ID
  `com.pixelview.desktop`, dedicated ICNS/tray assets and the authentic `pv-home` wordmark. Windows
  and Linux resources are branded in source but only source-tested.
